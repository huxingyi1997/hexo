...
14. 《OpenSSL攻略》
15. [Wireshark Doc SSL](https://link.zhihu.com/?target=http%3A//SSL%20-%20The%20Wireshark%20Wiki)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee1e5c87aa?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee3331569a?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee3d18e3b3?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee45d07de6?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee50805e63?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

最终，相同的 Header 只需要发送索引值，新的 Header 会重新加入 Dynamic Table。

### **05.请求优先级（Request Priorities）**
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee5cbb8b0e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee711d4128?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

这个是已经添加了对应模块。没有这两个模块的需要手动编译安装。

### **03.找到nginx文件目录**

![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee773a838f?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee7fbed777?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee8673d2af?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208ee9fd8cf0e?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

### **05.更改nginx配置**

安装结束后将nginx.config文件中443端口添加http2；

![img](https://user-gold-cdn.xitu.io/2019/10/31/16e208eea00bbd84?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
打开chrome调试工具，在network勾选protocol项，h2代表的是http2.0协议；
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922123003302.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922123253603.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922123855517.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922124004308.png#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922124129106.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922124303607.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922132748609.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922125205577.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922125953787.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dvbGZHdWlEYW8=,size_16,color_FFFFFF,t_70#pic_center)
...
可以认为 TCP 的 RTT 计算：![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922134807851.png#pic_center)

而 Quic 计算如下：![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922134824234.png#pic_center)

当然 RTT 的具体计算没有这么简单，需要采样，参考历史数值进行平滑计算，参考如下公式:![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922134848538.png#pic_center)
...
针对 Stream：![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922135129300.png#pic_center)

针对 Connection：![在这里插入图片描述](https://img-blog.csdnimg.cn/20200922135146282.png#pic_center)
...
![img](https://img-blog.csdnimg.cn/20200527233303721.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0xMODQ1ODc2NDI1,size_16,color_FFFFFF,t_70)
...
![img](https://img-blog.csdnimg.cn/20200527233345809.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0xMODQ1ODc2NDI1,size_16,color_FFFFFF,t_70)
...
![img](https://img-blog.csdnimg.cn/20200527233405188.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0xMODQ1ODc2NDI1,size_16,color_FFFFFF,t_70)
...
![img](https://img-blog.csdnimg.cn/20200527233424850.png)
...
废话少说，首先，我们需要知道TCP在网络OSI的七层模型中的第四层——Transport层（传输层），IP在第三层——Network层（网络层），ARP在第二层——Data Link层（数据链路层），在第二层上的数据，我们叫Frame（帧），在第三层上的数据叫Packet（数据包），第四层的数据叫Segment（片段）。
...
这种差错检验的检错能力不强，但是简单，速度快https://link.zhihu.com/?target=https%3A//blog.csdn.net/blogdevteam/article/details/90369522)
